...
import (
	...
	"github.com/opskumu/crd-example/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type TestV1Interface interface {
	RESTClient() rest.Interface
	ConfigMapHistoriesGetter
}

// TestV1Client is used to interact with features provided by the test.opskumu.com group.
type TestV1Client struct {
	restClient rest.Interface
}

func (c *TestV1Client) ConfigMapHistories(namespace string) ConfigMapHistoryInterface {
	return newConfigMapHistories(c, namespace)
}
